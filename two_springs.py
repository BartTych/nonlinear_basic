...
def calculate_nonlinear_spring_system(l_multi, n_multiplier,n_exp,amplitude):
    ...
    k = np.array([40000.0,20000.0])      # stiffnesses
    a = np.array([n_exp, n_exp])           # power exponent: 2.0 means nonlinear
...
data_storage = []
for n in np.linspace(0, 15, 11):
    u_1 = calculate_nonlinear_spring_system(0.8, n, 2.0, 0.01)
